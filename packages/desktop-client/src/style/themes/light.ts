...
export const tableBorderSelected = colorPalette.monarchTeal500;
export const tableBorderHover = colorPalette.monarchTeal400;
...
export const menuItemTextSelected = colorPalette.monarchTeal500;
export const menuItemTextHeader = colorPalette.navy400;
export const menuBorder = colorPalette.navy100;
export const menuBorderHover = colorPalette.monarchTeal100;
...
export const formInputBackgroundSelection = colorPalette.monarchTeal500;
export const formInputBorder = colorPalette.navy150;
export const formInputTextReadOnlySelection = colorPalette.navy50;
export const formInputBorderSelected = colorPalette.monarchTeal500;
...
export const formInputShadowSelected = colorPalette.monarchTeal300;
export const formInputTextHighlight = colorPalette.monarchTeal200;
