...
import { PlaidInitialiseModal } from './modals/PlaidInitialiseModal';
...
import { PlaidLinkModal } from './plaid/PlaidLinkModal';
  ...
  const modals = modalStack
    .map((modal, idx) => {
      ...
      switch (name) {
        ...
        case 'plaid-init':
          return <PlaidInitialiseModal key={key} {...modal.options} />;
